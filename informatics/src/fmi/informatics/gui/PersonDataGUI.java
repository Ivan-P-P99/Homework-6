...
public class PersonDataGUI {
	...
	public void createAndShowGUI() {
		...
		JButton buttonReset = new JButton("Възтанови");
		...
		final JDialog InformationDialog = new CustomDialog(null, null, null);
		...
		table.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				if (e.getClickCount() == 2) {   
					...
					int searchedEgn = (int) (table.getValueAt(row,1));
					
					for (Person person:
						 people) {
						if(person.getEgn() == searchedEgn){
							information.append("Име: " + person.getName() + "\n");
							if(person.getGender() == 'm') {
								information.append("Пол: Male.\n");
							}
							else {
								information.append("Gender: Female.\n");
							}
							information.append("ЕГЕНЕ: " + person.getEgn() + "\n");
							information.append("Години: " + person.getAge() + "\n");
							information.append("Височина: " + person.getHeight() + "\n");
							information.append("Тегло: " + person.getWeight() + "\n");
